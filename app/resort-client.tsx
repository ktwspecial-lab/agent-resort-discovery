...
type Agent = { id: string; name: string; ownerName: string; tripStatus: string; title: string; stars: number; palmPoints: number; prestigeStatus?: string | null };
